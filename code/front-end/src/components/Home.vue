<template>
  <el-container class="home-container">
    ...
    <el-header>
      <div>
        <img src="../assets/logo.jpg" style="width: 65px;height: 65px;margin-left: 28px;margin-top: 0px" />
        <span style="margin-left: 30px">昊鸣连锁超市</span>
      </div>
      <div>
        <!-- <el-button type="info">
